...
#SBATCH -n 1
#SBATCH -t 02:00:00
#SBATCH -J RNA-Serum-trim_reads
#SBATCH -o RNA-Serum-trim.out
#SBATCH -e RNA-Serum-trim.err
...
OUTDIR=/home/doya3905/Genome-Analysis-1MB462-67615-VT2025/results/RNA/Serum-Trimmed
